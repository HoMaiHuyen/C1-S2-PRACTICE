...
const STUDENTS_DATA = [
  { firstName: "An", lastName: "Tran", batch: "A", age: 20 },
  { firstName: "Bình", lastName: "Ploong", batch: "B", age: 22 },
  { firstName: "Cẩm", lastName: "Phan", batch: "C", age: 21 },
  { firstName: "An", lastName: "Hoang", batch: "A", age: 19 }, // Duplicate first name !
];
...
updateStudentAge("An", "Hoang", "A", 30);
